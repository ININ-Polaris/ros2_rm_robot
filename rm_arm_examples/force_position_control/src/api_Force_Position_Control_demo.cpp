...
ForcePositionControlDemoPub::ForcePositionControlDemoPub() : rclcpp::Node("Force_Position_Control_pub_node") {
  ...
  set_force_postion_publisher_ = this->create_publisher<rm_ros_interfaces::msg::Setforceposition>(
      "/rm_driver/set_force_postion_cmd", rclcpp::ParametersQoS());
  stop_force_postion_publisher_ =
      this->create_publisher<std_msgs::msg::Bool>("/rm_driver/stop_force_postion_cmd", rclcpp::ParametersQoS());
...
ForcePositionControlDemoSub::ForcePositionControlDemoSub() : rclcpp::Node("Force_Position_Control_sub_node") {
  movej_p_subscription_ = this->create_subscription<std_msgs::msg::Bool>(
      ...
      std::bind(&ForcePositionControlDemoSub::MoveJPDemo_Callback, this, _1));
  movel_subscription_ = this->create_subscription<std_msgs::msg::Bool>(
      "/rm_driver/movel_result", rclcpp::ParametersQoS(),
      std::bind(&ForcePositionControlDemoSub::MoveLDemo_Callback, this, _1));
  set_force_postion_subscription_ = this->create_subscription<std_msgs::msg::Bool>(
      "/rm_driver/set_force_postion_result", rclcpp::ParametersQoS(),
      std::bind(&ForcePositionControlDemoSub::SetForcePostionDemo_Callback, this, _1));
  stop_force_postion_subscription_ = this->create_subscription<std_msgs::msg::Bool>(
      "/rm_driver/stop_force_postion_result", rclcpp::ParametersQoS(),
      std::bind(&ForcePositionControlDemoSub::StopForcePostionDemo_Callback, this, _1));

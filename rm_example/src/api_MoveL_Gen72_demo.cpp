...
MoveLDemo::MoveLDemo() : rclcpp::Node("Movel_demo_node") {
  ...
  subscription_ = this->create_subscription<std_msgs::msg::Bool>("/rm_driver/movej_p_result", rclcpp::ParametersQoS(),
                                                                 std::bind(&MoveLDemo::MoveJPDemo_Callback, this, _1));
  publisher_ =
  ...
  movel_subscription_ = this->create_subscription<std_msgs::msg::Bool>(
      "/rm_driver/movel_result", rclcpp::ParametersQoS(), std::bind(&MoveLDemo::MoveLDemo_Callback, this, _1));
  movel_publisher_ =

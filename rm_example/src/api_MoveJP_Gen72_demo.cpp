...
MoveJPDemo::MoveJPDemo() : rclcpp::Node("Movejp_demo_node") {
  ...
  movejp_subscription_ = this->create_subscription<std_msgs::msg::Bool>(
      "/rm_driver/movej_p_result", rclcpp::ParametersQoS(), std::bind(&MoveJPDemo::MoveJPDemo_Callback, this, _1));
  movejp_publisher_ =

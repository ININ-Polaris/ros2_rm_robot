...
ChangeWorkFrame::ChangeWorkFrame() : rclcpp::Node("changeframe") {
  subscription_ =
      this->create_subscription<std_msgs::msg::Bool>("/rm_driver/change_work_frame_result", rclcpp::ParametersQoS(),
                                                     std::bind(&ChangeWorkFrame::ChangeWorkState_Callback, this, _1));
  publisher_ =
      this->create_publisher<std_msgs::msg::String>("/rm_driver/change_work_frame_cmd", rclcpp::ParametersQoS());
